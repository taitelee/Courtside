...
import CameraComponent from './components/CameraComponent'; //to get it working on the web
import { joinQueue, leaveQueue, getQueue, getCourtInfo, getPlayingTeams, removePlayingTeam, extendPlayTime, joinSlot, registerPushNotificationToken } from './app_src/services/api';
import { useQueueRealtime } from './app_src/hooks/useQueueRealtime';
import { Ionicons } from '@expo/vector-icons';
import AsyncStorage from '@react-native-async-storage/async-storage';
import { registerForPushNotificationsAsync } from './app_src/utils/notification';
...
function AppContent() {
  ...
  const handleJoinQueue = async (courtIdParam = null) => {
    console.log("🔥 handleJoinQueue FIRED");
